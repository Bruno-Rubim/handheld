...
export const firstRoom = new Room({name:'firstRoom', playerStartPos:{posX: 2, posY: 5}, loadObjects(){
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 0)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 1)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 2)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 8, 12, 3)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 8, 12, 6)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 7)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 8)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 9)
    firstRoom.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 0)

    firstRoom.objectList.push(new Wall({posX: 1, posY: 3}))
    firstRoom.objectList.push(new Wall({posX: 1, posY: 6}))
...
export const room2Levers = new Room({name:'room2Levers', playerStartPos:{posX: 0, posY: 5}, loadObjects(){
    room2Levers.addLineToObjectList(()=>new Wall({}), 'x', 0, 8, 0)
    room2Levers.addLineToObjectList(()=>new Wall({}), 'x', 0, 8, 1)

    room2Levers.objectList.push(new Wall({posX:9, posY:1}))
    room2Levers.addLineToObjectList(()=>new FlipWall({color:'white', state:'off'}), 'x', 10, 12, 1)
    room2Levers.objectList.push(new Wall({posX:13, posY:1}))

    room2Levers.addLineToObjectList(()=>new Wall({}), 'x', 0, 8, 2)
    room2Levers.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 7)
    room2Levers.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 8)
    room2Levers.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 9)

    room2Levers.objectList.push(new Wall({posX:7, posY:3}))
    room2Levers.addLineToObjectList(()=>new FlipWall({color:'white', state:'on'}), 'y', 4, 5, 7)
    room2Levers.objectList.push(new Wall({posX:7, posY:6}))

    room2Levers.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 14)
    room2Levers.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 15)
...
export const roomDisc1 = new Room({name:'room1Disc', playerStartPos:{posX: 12, posY: 9}, loadObjects(){
    roomDisc1.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 0)
    roomDisc1.addLineToObjectList(()=>new Wall({}), 'x', 5, 8, 1)
    roomDisc1.addLineToObjectList(()=>new Wall({}), 'x', 5, 8, 7)
    roomDisc1.addLineToObjectList(()=>new Wall({}), 'x', 0, 8, 8)
    roomDisc1.addLineToObjectList(()=>new Wall({}), 'x', 0, 8, 9)
    roomDisc1.addLineToObjectList(()=>new FlipWall({color:'white', state:'on'}), 'y', 1, 7, 2)
    roomDisc1.addLineToObjectList(()=>new Wall({}), 'y', 8, 9, 14)
    roomDisc1.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 15)
...
export const roomDisc2 = new Room({name:'roomDisc2', playerStartPos:{posX: 15, posY: 4}, loadObjects(){
    roomDisc2.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 0)
    roomDisc2.addLineToObjectList(()=>new Wall({}), 'x', 0, 14, 1)
    roomDisc2.addLineToObjectList(()=>new Wall({}), 'x', 1, 13, 2)
    roomDisc2.addLineToObjectList(()=>new Wall({}), 'x', 5, 8, 1)
    roomDisc2.addLineToObjectList(()=>new Wall({}), 'x', 1, 13, 7)
    roomDisc2.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 8)
    roomDisc2.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 9)
...
export const roomDiscLever = new Room({name:'roomDiscLever2', playerStartPos:{posX: 15, posY: 4}, loadObjects(){
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'x', 0, 4, 0)
    roomDiscLever.addLineToObjectList(()=>new FlipWall({color:'white', state:'on'}), 'x', 5, 9, 0)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'x', 10, 15, 0)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'x', 0, 4, 1)
    roomDiscLever.addLineToObjectList(()=>new FlipWall({color:'blue', state:'on'}), 'x', 5, 9, 1)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'x', 10, 15, 1)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'x', 0, 4, 7)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 8)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 9)

    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 0)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'y', 0, 2, 1)
    roomDiscLever.addLineToObjectList(()=>new Wall({}), 'y', 6, 9, 1)
...
export const room2Discs = new Room({name:'room2Discs', playerStartPos:{posX: 7, posY:9}, loadObjects(){
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 0)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 1)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 12, 15, 2)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 12, 15, 7)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 10, 15, 8)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 0, 4, 8)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 0, 4, 9)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'x', 10, 15, 9)

    room2Discs.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 0)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 1)
    room2Discs.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 2)
