import { Box, Disc, DiscScanner, FlipWall, PressurePlate, Wall } from '../game-objects.js'
...
export const roomPushBox1 = new Room({name:'roomPushBox1', playerStartPos:{posX: 0, posY:5}, loadObjects(){
    ...
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 0)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 1)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 2)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 2, 6, 3)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 8, 15, 3)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 7)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 8)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 9)
    
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'y', 0, 2, 0)
    roomPushBox1.addLineToObjectList(()=>new Wall({}), 'y', 7, 9, 0)
...
export const roomPushBox2 = new Room({name:'roomPushBox2', playerStartPos:{posX: 0, posY:5}, loadObjects(){
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 0)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 0, 10, 1)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 0, 10, 2)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 8, 10, 3)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 8, 10, 7)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 0, 10, 8)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 0, 10, 9)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'x', 14, 15, 9)

    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'y', 0, 3, 0)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'y', 7, 9, 0)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 14)
    roomPushBox2.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 15)
...
export const roomPullBox = new Room({name:'roomPullBox', playerStartPos:{posX: 12, posY:0}, loadObjects(){
    roomPullBox.addLineToObjectList(()=>new Wall({}), 'x', 0, 10, 0)
    roomPullBox.addLineToObjectList(()=>new Wall({}), 'x', 14, 15, 0)
    roomPullBox.addLineToObjectList(()=>new Wall({}), 'x', 6, 15, 4)
    roomPullBox.addLineToObjectList(()=>new Wall({}), 'x', 6, 15, 5)
    roomPullBox.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 9)

    roomPullBox.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 0)
    roomPullBox.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 1)
    roomPullBox.addLineToObjectList(()=>new Wall({}), 'y', 0, 5, 15)
...
export const roomBoxPlates = new Room({name:'roomBoxPlates', playerStartPos:{posX: 0, posY:7}, loadObjects(){
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'x', 0, 10, 0)
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'x', 0, 15, 9)

    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'y', 0, 5, 0)
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'y', 0, 3, 1)
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'y', 0, 3, 2)
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'y', 0, 9, 15)

    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'y', 0, 1, 10)
    ...
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'y', 0, 1, 14)
    ...
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'x', 0, 4, 4)
    roomBoxPlates.addLineToObjectList(()=>new FlipWall({color:'green', state:'on'}), 'x', 5, 8, 4)
    roomBoxPlates.addLineToObjectList(()=>new Wall({}), 'x', 9, 15, 4)
