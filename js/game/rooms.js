    ...
    findObjectByPosition(posX, posY, layer){
        for(let i = 0; i < this.objectList.length; i++){
            if (this.objectList[i].posX == posX &&
                ...
                this.objectList[i].gameLayer == layer) {
...
// testRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
// testRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)
// testRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 0)
// testRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 2, 15)
// testRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 7, 9, 15)

//first room; Introduces button and flip walls
export let firstRoom = new Room({playerStartPos:{posX: 2, posY: 5}})

firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 1)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 2)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 8, 12, 3)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 8, 12, 6)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 7)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 8)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)
firstRoom.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 0)

firstRoom.objectList.push ({posX: 1, posY: 3, name: 'wall', gameLayer:'player'})
firstRoom.objectList.push ({posX: 1, posY: 6, name: 'wall', gameLayer:'player'})
...
room2Buttons.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 8, 0)
room2Buttons.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 8, 1)

room2Buttons.objectList.push({name:'wall', renderLayer:'wall', gameLayer:'player', posX:9, posY:1})
room2Buttons.addLineToObjectList(new FlipWall({color:'white', state:'off'}), 'x', 10, 12, 1)
room2Buttons.objectList.push({name:'wall', renderLayer:'wall', gameLayer:'player', posX:13, posY:1})

room2Buttons.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 8, 2)
room2Buttons.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 7)
room2Buttons.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 8)
room2Buttons.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)

room2Buttons.objectList.push({name:'wall', renderLayer:'wall', gameLayer:'player', posX:7, posY:3})
room2Buttons.addLineToObjectList(new FlipWall({color:'white', state:'on'}), 'y', 4, 5, 7)
room2Buttons.objectList.push({name:'wall', renderLayer:'wall', gameLayer:'player', posX:7, posY:6})
...
room1Disc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
room1Disc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 5, 8, 1)
room1Disc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 5, 8, 7)
room1Disc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 8, 8)
room1Disc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 8, 9)
room1Disc.addLineToObjectList(new FlipWall({color:'white', state:'on'}), 'y', 1, 7, 2)
room1Disc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 8, 9, 14)
room1Disc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 15)
...
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 4, 0)
roomDiscButton.addLineToObjectList(new FlipWall({color:'white', state:'on'}), 'x', 5, 9, 0)
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 15, 0)
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 4, 1)
roomDiscButton.addLineToObjectList(new FlipWall({color:'blue', state:'off'}), 'x', 5, 9, 1)
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 15, 1)
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 4, 7)
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 8)
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)

roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 0)
roomDiscButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 2, 1)
...
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 1)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 12, 15, 2)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 12, 15, 7)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 15, 8)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 4, 8)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 4, 9)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 15, 9)

room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 0)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 1)
room2Discs.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 2)
...
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 1)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 1, 15, 2)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 4, 10, 3)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 4, 10, 7)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 10, 8)
roomPushBox1.addLineToObjectList(new FlipWall({color:'green', state:'on'}), 'x', 11, 13, 8)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 10, 9)

roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 2, 0)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 7, 9, 0)
roomPushBox1.addLineToObjectList(new FlipWall({color:'green', state:'off'}), 'y', 4, 6, 4)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 14)
roomPushBox1.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 15)
...
roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 10, 0)
roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 14, 15, 0)
roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 6, 15, 4)
roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 6, 15, 5)
roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)

roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 0)
roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 1)
roomPullBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 5, 15)
...
roomPushBox2.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 5, 0)
roomPushBox2.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 1)
roomPushBox2.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 1, 10)
...
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 10, 1)
roomRemoteButton.addLineToObjectList(new FlipWall({color:'white', state:'on'}), 'x', 10, 14, 4)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 10, 9)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 9, 8)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 14, 15, 9)

roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 0)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 1)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 8)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 9)
roomRemoteButton.addLineToObjectList(new FlipWall({color:'yellow', state:'on'}), 'y', 1, 3, 15)
roomRemoteButton.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 4, 9, 15)

roomRemoteButton.objectList.push(({name:'wall', posX: 7, posY: 2, gameLayer:'player'}))
roomRemoteButton.objectList.push(({name:'wall', posX: 2, posY: 2, gameLayer:'player'}))
...
roomRemoteDisc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
roomRemoteDisc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 5)
roomRemoteDisc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)
...
roomRemoteDisc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 11, 1)
...
roomRemoteDisc.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 11, 4)
...
roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 5, 15, 9)
roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 1, 9)

roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 4, 9, 0)
roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 7, 9, 1)
roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 7, 9, 4)
roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 15)
...
roomRemoteWallShift.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 1, 6, 11)
...
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 1, 0)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 4, 15, 0)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 11, 12, 1)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 11, 13, 3)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 11, 15, 4)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 12, 15, 5)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)

roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 9, 0)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 5, 8, 1)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 5, 8, 6)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 15)
roomRemotePushBox.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 14)
...
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 4)
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)

roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 5, 0)
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 1)
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 12)
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 13)
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 14)
roomRemoteBot3.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 5, 15)
...
roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 0)
roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 15, 5)
roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 10, 15, 3)
roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'x', 0, 15, 9)

roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 5, 0)
roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 5, 4)
roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 0, 3, 15)
roomRemoteBot4.addLineToObjectList({name:'wall', renderLayer:'wall', gameLayer:'player'}, 'y', 6, 9, 15)
...
roomRemoteBot4.objectList.push({name:'wall', renderLayer:'wall', gameLayer:'player', posX:7, posY:5})
